...
<body>
<center><h1 style="font-family:Arial, Helvetica, sans-serif;margin-top:25px;">WELCOME TO USER2</h1></center>
<h3>PRODUCT</h3>
<table style="width=100%;border:1px solid grey">
 ...
 <c:forEach items="${bidactives}" var="product">
   ...
   <tr>
          ...
          <td><center><button style="color:white;background:grey;border:grey;"><a href="Bid?id=${product.getProductId()}&name=User2" style="text-decoration:none;color:white;">Bid</a></button></center></td>
